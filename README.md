...
Projeto pessoal/técnico em desenvolvimento, com a proposta de criar uma página simples em HTML e CSS para organização de disciplinas, tarefas, prazos e projetos acadêmicos.

A ideia é aplicar conhecimentos básicos de desenvolvimento web em uma solução prática voltada à organização estudantil.
