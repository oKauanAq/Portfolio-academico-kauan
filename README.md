...
Este repositório também tem como finalidade praticar o uso de ferramentas importantes para a área de tecnologia, como Git, GitHub, GitHub Pages, documentação com Markdown, HTML, CSS, JavaScript e integração com plataformas profissionais.
...
Projeto pessoal/técnico desenvolvido como um protótipo funcional local para organização acadêmica.

O painel permite cadastrar disciplinas, tarefas e projetos diretamente no navegador, alterar status, excluir registros, carregar exemplos, limpar o painel e manter os dados salvos localmente por meio do localStorage.

A proposta do projeto é demonstrar uma solução simples e prática para organização de estudos, usando HTML, CSS e JavaScript puro, sem login, backend ou banco de dados externo.
...
Portfólio em desenvolvimento para a Entrega Intermediária da disciplina Bootcamp I.
